...
- Security: Algorithm whitelist validation with warning (HS256, HS384, HS512, RS256, RS384, RS512, ES256, ES384, ES512, EdDSA)
...
- Non-whitelisted algorithms now log warnings (throw in strict mode)
